...
export function resolveConnectedServiceCredentialRevision(params: Readonly<{
    ...
    // Legacy rows predate explicit revisions. This stable, non-secret revision remains valid until
    // the next credential mutation upgrades the metadata with a random revision.
