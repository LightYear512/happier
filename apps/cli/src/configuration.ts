...
function resolveServerSelection(params: Readonly<{
  ...
  if (envCanonicalServerUrl) {
    ...
    // URL-equivalent persisted profiles own credentials. Env-provided ids are a fallback for a
    // genuinely new runtime scope, not a reason to strand an existing matching access key.
