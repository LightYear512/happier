...
vi.mock('@/rpc/handlers/workspaceAnchors/registerWorkspaceAnchorHandlers', () => ({ registerWorkspaceAnchorHandlers: vi.fn() }));
vi.mock('@/rpc/handlers/workspaceFavicon/registerWorkspaceFaviconHandlers', () => ({ registerWorkspaceFaviconHandlers: vi.fn() }));
