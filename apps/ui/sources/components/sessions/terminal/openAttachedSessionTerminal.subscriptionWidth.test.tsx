...
describe('useOpenAttachedSessionTerminal subscription width', () => {
    ...
    it('keeps its api identity while source fields churn without changing attachability', async () => {
        ...
        // updatedAt, seq. Providers may use some of those fields when deriving attachability,
        // but this fixture's derived decision remains unchanged. The hook subscribes to that
        // decision because the header menu compares `onSelectExtraItem` by identity.
        await act(async () => {
