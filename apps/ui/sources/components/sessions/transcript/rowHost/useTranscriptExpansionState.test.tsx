...
describe('useTranscriptExpansionState', () => {
    it('prepares detached visible-anchor ownership before rendering controlled thinking expanded', async () => {
        ...
        const deferAutoPinAfterLocalTranscriptInteraction = vi.fn();
        ...
        expect(deferAutoPinAfterLocalTranscriptInteraction).toHaveBeenCalledTimes(1);

        ordering.length = 0;
        deferAutoPinAfterLocalTranscriptInteraction.mockClear();
    ...
    it('keeps pinned-tail ownership across thinking and tool expansion at web bottom', async () => {
        ...
        expect(deferAutoPinAfterLocalTranscriptInteraction).not.toHaveBeenCalled();
