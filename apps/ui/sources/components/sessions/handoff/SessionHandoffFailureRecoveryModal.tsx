...
export function SessionHandoffFailureRecoveryModal({ onClose, setChrome, title, message, details, recovery, onResolve }: Props) {
    ...
    const canRetrySourceCleanup = recovery.actions.includes('retry_source_cleanup');
    ...
    ), [canKeepStopped, canRestart, canRetrySourceCleanup, handleResolve, styles.footer]);
