...
export type SessionTranscriptNavigationPaneProps = Readonly<{
     ...
     * this pane (the phone cockpit "Navigation" surface) pass their surface switch; hosts
     * that render it beside a live transcript (the desktop right pane) pass nothing.
     */
