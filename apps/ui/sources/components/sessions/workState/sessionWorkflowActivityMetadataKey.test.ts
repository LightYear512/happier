...
/**
 * Cross-repo metadata-key parity lock (DW2 / D-9, back-ported from ../dev).
 *
 ...
 * silently break cross-repo compatibility: a headline written by ../dev must be readable here and
 * vice versa.
 */
