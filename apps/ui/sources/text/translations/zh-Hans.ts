...
export const zhHans: TranslationStructure = {
  ...
  externalIssues: {
    title: "外部议题",
    detailTitle: "外部议题",
    fallbackIssueTitle: "外部议题",
    empty: "暂无外部议题",
    unknown: "未知",
    unknownRepository: "未知仓库",
    workflowUnknown: "工作流未知",
    workflow: "工作流",
    sessionRun: "会话运行",
    providerActions: "提供方操作",
    noLatestRun: "暂无最新运行",
    noActiveRun: "暂无活动运行",
    noActivePrimaryRun: "暂无活动主运行",
    noProviderActions: "暂无提供方操作",
    noProviderResult: "暂无提供方结果",
    generation: ({ generation }: { generation: number }) => `第 ${generation} 代`,
    generationUnknown: "代数未知",
    latestRunState: ({ state }: { state: string }) => `最新运行 ${state}`,
    claimedByMachine: ({ machineId }: { machineId: string }) => `由 ${machineId} 领取`,
    unclaimed: "未领取",
    missingIssueRefId: "缺少议题引用。",
    a11y: {
      openList: "外部议题",
      refreshList: "刷新外部议题",
      refreshDetail: "刷新外部议题",
    },
  },
  ...
  settingsFeatures: {
    ...
    expSessionsDevPreview: "本地与模拟器预览",
    expSessionsDevPreviewSubtitle: "允许会话代理注册本地 Web 应用和模拟器预览，以便在 app 内预览",
