...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  ...
  settings: {
    ...
    settingsFeatures: {
        ...
        expSessionsDevPreview: '本機與模擬器預覽',
        expSessionsDevPreviewSubtitle: '允許工作階段代理註冊本機 Web 應用程式和模擬器預覽，以便在 app 內預覽',
...
settingsSession: {
    ...
    profiles: {
        ...
        provision: {
            title: '在裝置上配置',
            provisionOnMachine: '在裝置上配置',
            modalTitle: ({ backend }: { backend: string }) => `配置 ${backend}`,
            inProgressHint: '按照 CLI 提示完成登入。',
        ...
        switch: {
            title: '切換設定檔',
            count: ({ count }: { count: number }) => `${count} 個可用設定檔`,
            confirmTitle: '切換設定檔？',
            confirmBody: '目前工作階段將使用所選設定檔重新啟動。',
            errorTitle: '設定檔切換失敗',
            errorBody: '無法切換工作階段設定檔。',
            turnInProgress: '等待目前回合結束後再重試。',
        },
        aiBackend: {
