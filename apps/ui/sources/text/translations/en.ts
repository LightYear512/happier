...
export const en = {
    ...
    settingsFeatures: {
        ...
        expSessionsDevPreview: 'Local and simulator previews',
        expSessionsDevPreviewSubtitle: 'Let session agents register local web apps and simulator previews for in-app preview',
