...
export const ca: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        expSessionsDevPreview: 'Previsualitzacions locals de desenvolupament',
        expSessionsDevPreviewSubtitle: 'Permet que els agents de sessió registrin apps web locals per previsualitzar-les a l’app',
