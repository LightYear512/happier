...
export const ca: TranslationStructure = {
  ...
  externalIssues: {
    title: 'Incidències externes',
    detailTitle: 'Incidència externa',
    fallbackIssueTitle: 'Incidència externa',
    empty: 'No hi ha incidències externes',
    unknown: 'desconegut',
    unknownRepository: 'repositori desconegut',
    workflowUnknown: 'workflow desconegut',
    workflow: 'Flux de treball',
    sessionRun: 'Execució de sessió',
    providerActions: 'Accions del proveïdor',
    noLatestRun: 'cap execució recent',
    noActiveRun: 'cap execució activa',
    noActivePrimaryRun: 'cap execució principal activa',
    noProviderActions: 'cap acció del proveïdor',
    noProviderResult: 'cap resultat del proveïdor',
    generation: ({ generation }: { generation: number }) => `generació ${generation}`,
    generationUnknown: 'generació desconeguda',
    latestRunState: ({ state }: { state: string }) => `execució recent: ${state}`,
    claimedByMachine: ({ machineId }: { machineId: string }) => `reclamada per ${machineId}`,
    unclaimed: 'sense reclamar',
    missingIssueRefId: 'Falta la referència de la incidència.',
    a11y: {
      openList: 'Incidències externes',
      refreshList: 'Actualitza les incidències externes',
      refreshDetail: 'Actualitza la incidència externa',
    },
  },
  ...
  sessionLog: {
    ...
    connectedServices: {
        ...
        quota: {
            ...
            recoveryCreditSubtitle: 'Aplica un restabliment d\'ús per recuperar la quota ara.',
            recoveryCreditExpires: ({ time }: { time: string }) => `Expires: ${time}`,
            recoveryCreditApplying: 'S\'està aplicant el restabliment…',
    ...
    settingsFeatures: {
        ...
        expSessionsDevPreview: 'Previsualitzacions locals i de simulador',
        expSessionsDevPreviewSubtitle: 'Permet que els agents de sessió registrin apps web locals i previsualitzacions de simulador a l’app',
