...
const IGNORED_UNTRANSLATED_KEYS = new Set([
    ...
    'settings.devMotionPrimitivesTitle',
    'settings.devMotionPrimitivesFooter',
    'settings.devMotionSlideVariantsTitle',
    'settings.devMotionSlideVariantsSubtitle',
    'settings.devMotionReducedMotionLabel',
    'settings.devMotionDiscreteTitle',
    'settings.devMotionDiscreteBody',
    'settings.devMotionBack',
    'settings.devMotionForward',
    'settings.devMotionCarouselTitle',
    'settings.devMotionCarouselBody',
    'settings.devMotionContinue',
    'settings.devMotionModalTitle',
    'settings.devStoryDeckPreviewTitle',
    'settings.devStoryDeckPreviewFooter',
    'settings.devStoryDeckOnboardingTitle',
    'settings.devStoryDeckNoReleaseTitle',
    'settings.devStoryDeckNoReleaseSubtitle',
    'settings.devWebHmrTitle',
    'settings.devWebHmrToggleTitle',
    'settings.devWebHmrRuntimeDetected',
    'settings.devWebHmrRuntime',
    'settings.devWebHmrEnabled',
    'settings.devWebHmrDisabled',
    'settings.devWebHmrReload',
]);
