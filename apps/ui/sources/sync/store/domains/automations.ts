...
const AUTOMATION_RUNS_RETENTION_MAX_PER_AUTOMATION = loadSyncTuning().automationRunsRetentionMaxPerAutomation;
...
function sortRunsNewestFirst(runs: AutomationRun[]): AutomationRun[] {
    return runs
        ...
        .slice(0, AUTOMATION_RUNS_RETENTION_MAX_PER_AUTOMATION);
}
