...
export type DeliverHiddenSessionScmMutationSignalParams = Readonly<{
    ...
    /** Test seam mirroring WorkspaceMutationIngestionOptions; production uses the runtime singleton. */
...
export async function deliverHiddenSessionScmMutationSignal(
    ...
    if (!resolveSessionScmMutationSignal(params.sessionId, params.sourceServerId)) return;
