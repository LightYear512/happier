/**
 * Test-only adapter for stateful fake agents written as plain method objects.
 *
 * The SDK's public AgentApp owns transport/dispatch. The small facade passed to fake agents
 * exposes only client-bound calls used by provider fixtures, keeping individual E2E scripts
 * free of deprecated connection wrappers and package-internal imports.
 */
